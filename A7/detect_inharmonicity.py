...
#inMean = estimateInharmonicity()
#inMean = estimateInharmonicity(inputFile = '../../sounds/speech-female.wav', t1=0.0, t2=3.0, window='blackman', M=4001, N=4096, H=128, f0et=7.0, t=-90, minf0=0, maxf0=700, nH = 1000)
inMean = estimateInharmonicity(inputFile = 'Part2/75945__noisecollector__wildwood-thankyoumono.wav', t1=0.0, t2=5.0, window='blackman', M=1201, N=16384, H=128, f0et=7.0, t=-90, minf0=0, maxf0=700, nH = 1000)
print inMean
